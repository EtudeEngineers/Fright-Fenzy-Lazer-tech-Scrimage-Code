...
public class BlueWarehouseTwiceAuto extends LinearOpMode {
    ...
    public double AmountofBlocksGotten = 1;
    // Default to IDLE
                ...
                case IntakeUntilTouchSensor:
                    ...
                    if ((donewithIntake||hasABlock)&&AmountofBlocksGotten<3 && TotalTime.seconds()<30) { //If we still have time to keep going:
                        ...
                        TrajectorySequence trajectory4 = drive.trajectorySequenceBuilder(poseEstimate)
                                .strafeLeft(2)
                                .splineToConstantHeading(new Vector2d(5,65),Math.toRadians(0)) //Gets just outside of warehouse
                                .splineToLinearHeading(new Pose2d(-11.75, 44.25-AmountofBlocksGotten*0),Math.toRadians(90))
                                .splineToLinearHeading(new Pose2d(-11.75, 39.25-AmountofBlocksGotten*0,Math.toRadians(90)),Math.toRadians(90))
                                .build();
