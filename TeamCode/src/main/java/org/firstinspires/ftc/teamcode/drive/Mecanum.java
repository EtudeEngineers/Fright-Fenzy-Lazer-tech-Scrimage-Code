...
public class Mecanum {
    ...
    public static Wheels motionToWheels(Motion motion) {
        ...
        double frontLeft = Math.sqrt(2)*vD *
                ...
                + vTheta;
        double frontRight = Math.sqrt(2)*vD * Math.cos(thetaD + Math.PI / 4)
                - vTheta;
        double backLeft = Math.sqrt(2)*vD * Math.cos(thetaD + Math.PI / 4)
                + vTheta;
        double backRight = Math.sqrt(2)*vD * Math.sin(thetaD + Math.PI / 4)
                - vTheta;
