...
//Simple Plan #?
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence t2 = drive.trajectorySequenceBuilder(t1.end())
                //.back(7.5)
                .lineToConstantHeading(new Vector2d(-39.375, 48.675)) //y was like 4 inches too little, x was like an inch too little
                .build();
...
//                .build();
        ...
        TrajectorySequence t4 = drive.trajectorySequenceBuilder(t3.end())
                .forward(5)
                .splineTo(new Vector2d(-60, 35.25), Math.toRadians(180)) //Center from x seems to be 2 inches off, Center for y seems to be 6 inches from what should have been center
                .build();
...
//                .splineTo(new Vector2d(-60, 35.25), Math.toRadians(180))
        ...
        else if (drive.Color2.green()>85) //Needs to be at least >76
        {
            level = 2;
            telemetry.addData("Level:",level);
            telemetry.addData("Color:",drive.Color.green());
